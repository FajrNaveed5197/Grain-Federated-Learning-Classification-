#!/bin/bash
#SBATCH --job-name=rice_fedrep_mob_iid
...
#SBATCH --output=/scratch/project_2019765/fnaveed/logs/rice_fedrep_mob_iid_%j.out
#SBATCH --error=/scratch/project_2019765/fnaveed/logs/rice_fedrep_mob_iid_%j.err
...
mkdir -p \
  ...
  /scratch/project_2019765/fnaveed/results/rice_fedrep_iid_mobilenetv2
