#!/bin/bash
#SBATCH --job-name=rice_fl_noniid_full
...
#SBATCH --output=/scratch/project_2019765/fnaveed/logs/rice_fl_noniid_full_%j.out
#SBATCH --error=/scratch/project_2019765/fnaveed/logs/rice_fl_noniid_full_%j.err
...
mkdir -p \
  ...
  /scratch/project_2019765/fnaveed/results/rice_fedavg_noniid_resnet18
