#!/bin/bash
#SBATCH --job-name=rice_fl_iid_full
...
#SBATCH --output=/scratch/project_2019765/fnaveed/logs/rice_fl_iid_full_%j.out
#SBATCH --error=/scratch/project_2019765/fnaveed/logs/rice_fl_iid_full_%j.err
...
mkdir -p \
  ...
  /scratch/project_2019765/fnaveed/results/rice_fedavg_iid_resnet18
