#!/bin/bash
#SBATCH --job-name=rice_fedper_mob_iid
...
#SBATCH --output=/scratch/project_2019765/fnaveed/logs/rice_fedper_mob_iid_%j.out
#SBATCH --error=/scratch/project_2019765/fnaveed/logs/rice_fedper_mob_iid_%j.err
...
mkdir -p \
  ...
  /scratch/project_2019765/fnaveed/results/rice_fedper_iid_mobilenetv2

export PYTHONPATH=src
export PYTHONUNBUFFERED=1
export OMP_NUM_THREADS=4

python -m federated_pipeline.federated.fedper_rice_mobilenetv2_iid \
  --client-dir \
