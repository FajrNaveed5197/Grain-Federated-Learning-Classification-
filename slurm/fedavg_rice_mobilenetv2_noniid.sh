...
#SBATCH --output=/scratch/project_2019765/fnaveed/logs/rice_mob_noniid_%j.out
#SBATCH --error=/scratch/project_2019765/fnaveed/logs/rice_mob_noniid_%j.err
...
mkdir -p \
  ...
  /scratch/project_2019765/fnaveed/results/rice_fedavg_noniid_mobilenetv2
