...
#SBATCH --output=/scratch/project_2019765/fnaveed/results/Logs/SLURM/rice_fedavg_mob_alpha0p1_%j.out
#SBATCH --error=/scratch/project_2019765/fnaveed/results/Logs/SLURM/rice_fedavg_mob_alpha0p1_%j.err
...
OUTPUT_DIR=/scratch/project_2019765/fnaveed/results/Rice/Federated/FedAvg/NonIID_alpha0p1/MobileNetV2
