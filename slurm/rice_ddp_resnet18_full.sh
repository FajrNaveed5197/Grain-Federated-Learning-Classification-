...
#SBATCH --output=/scratch/project_2019765/fnaveed/logs/rice_ddp_full_%j.out
#SBATCH --error=/scratch/project_2019765/fnaveed/logs/rice_ddp_full_%j.err
...
mkdir -p \
  ...
  /scratch/project_2019765/fnaveed/results/rice_ddp_resnet18
