...
PYTHONPATH=src python -m federated_pipeline.federated.evaluate_federated_checkpoint \
  --checkpoint /scratch/project_2019765/grain_research/federated_results/fl_full_iid_v3/global_model_round_3.pt \
  --root /scratch/project_2019765/grain_research \
  --output /scratch/project_2019765/grain_research/federated_results/fl_full_iid_v3/fixed_protocol_results.json \
  --batch-size 256 \
  --num-workers 4
