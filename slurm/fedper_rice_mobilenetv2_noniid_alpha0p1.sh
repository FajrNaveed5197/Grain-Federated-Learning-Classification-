...
#SBATCH --output=/scratch/project_2019765/fnaveed/results/Logs/SLURM/rice_fedper_mob_alpha0p1_%j.out
#SBATCH --error=/scratch/project_2019765/fnaveed/results/Logs/SLURM/rice_fedper_mob_alpha0p1_%j.err
...
OUTPUT_DIR=/scratch/project_2019765/fnaveed/results/Rice/Federated/FedPer/NonIID_alpha0p1/MobileNetV2
...
python -m federated_pipeline.federated.fedper_rice_mobilenetv2 \
  ...
  --experiment-name rice_fedper_noniid_alpha0p1_mobilenetv2 \
  --rounds 5 \
  --local-epochs 1 \
  --batch-size 64 \
  --learning-rate 2e-6 \
