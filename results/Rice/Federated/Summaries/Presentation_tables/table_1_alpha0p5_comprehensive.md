# Overall Rice Results with Non-IID α = 0.5
...
| FedAvg | Non-IID α=0.5 | ResNet18 | 99.10 | 98.20 | 98.09 | Global model |
...
- Dirichlet α=0.5 applies only to the non-IID federated rows. Centralized, DDP, and IID rows do not use α.
- FedAvg reports one global model. FedPer and FedRep report the mean performance of three personalized client models.
- Best overall Macro-F1 in this table: FedRep non-IID MobileNetV2 at 98.21%.
- Best global federated model: FedAvg IID ResNet18 at 98.11% Macro-F1.
