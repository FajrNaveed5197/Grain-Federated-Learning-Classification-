...
def save_confusion_matrix(
    ...
    axis.set_title("Rice EfficientNetB0 Test Confusion Matrix")
...
def main() -> None:
    ...
    checkpoint_path = (
        OUTPUT_DIR / "best_efficientnetb0_rice_grouped.pt"
    )
    ...
    for epoch_index in range(total_epochs):
        ...
        if epoch_index == WARMUP_EPOCHS:
            print("\nUnfreezing complete EfficientNetB0 model.")
    ...
    final_results = {
        "experiment": "rice_efficientnetb0_grouped_v1",
