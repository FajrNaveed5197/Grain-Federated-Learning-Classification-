...
def save_confusion_matrix(
    ...
    axis.set_title("Rice MobileNetV2 Test Confusion Matrix")
...
def main() -> None:
    ...
    checkpoint_path = (
        OUTPUT_DIR / "best_mobilenetv2_rice_grouped.pt"
    )
    ...
    for epoch_index in range(total_epochs):
        ...
        if epoch_index == WARMUP_EPOCHS:
            print("\nUnfreezing complete MobileNetV2 model.")
    ...
    final_results = {
        "experiment": "rice_mobilenetv2_grouped_v1",
