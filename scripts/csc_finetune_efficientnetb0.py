...
OUTPUT_DIR = Path("/scratch/project_2019649/grain_research/results/presentation_finetune_efficientnetb0")
...
def main():
    ...
    best_checkpoint = OUTPUT_DIR / "best_efficientnetb0_gpu.pt"
    history = []
    started = time.time()
